...
const Post = ({post}) => {
  ...
  return( 
    <div className='w-full flex flex-col items-center'>
        <div className="flex flex-col w-full max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-2xl dark:bg-gray-900 bg-gray-50 text-gray-100 border border-gray-300 dark:border-gray-800">
