                ...
                <div className="w-screen flex ">
                  <svg className=" bottom-0" viewBox="0 0 1425 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g>
                      ...
                      <path d="M0,134,23.75,132C47.5,129.91,95,125.8,142.5,125.39s95,2.88,142.5,5.75,95,5.35,142.5,4,95-6.58,142.5-8.06,95,.66,142.5-.41,95-5.51,142.5-9.21,95-6.66,142.5-5.83,95,5.42,142.5,9.86,95,8.47,142.5,9.05,95-2.47,118.75-4L1425,125v97.84H0Z" fill="currentColor" className={`text-${theme_color} text-opacity-55`}></path>
                      {/* <path d="M0,178.42l23.75-1.64c23.75-1.65,71.25-4.94,118.75-5.59s95,1.23,142.5,2.71,95,2.63,142.5,4.11,95,3.45,142.5,2.88,95-3.54,142.5-8.8,95-12.58,142.5-13.57,95,4.53,142.5,8.23,95,5.67,142.5,4,95-6.91,142.5-9.79,95-3.37,118.75-3.7L1425,157v65.78H0Z" fill="currentColor" className={`text-${theme_color} text-opacity-85`}></path> */}
                    </g>
                    <defs>
                    ...
                    <a href="#">
                      <div className="inline-flex items-center">
                        <svg
                          ...
                          height="30"
                          viewBox="0 0 50 56"
                          className={`text-${theme_color} text-opacity-60`}
                          fill="currentColor"
                        ...
                        <span className="ml-4 text-lg font-bold text-gray-600">AluMNNIT</span>
                      </div>
                    </a>
                  </div>
                  <div className="w-auto p-8 leading-tight">
                    <ul className="-m-5 flex flex-wrap items-center">
                      <li className="px-4 py-2">
                        <a className="font-medium text-gray-600 hover:text-gray-700 dark:hover:text-gray-500" href="#">
                          Privacy Policy
                        </a>
                      </li>
                      <li className="px-4 py-2">
                  ...
                  <div className="w-auto p-5">
                    <div className="-m-1.5 flex flex-wrap">
                      <div className="w-auto p-1.5">
                        <a href="https://www.instagram.com/rishi_poswal__/" target="_blank">
                          <div className={`flex h-8 w-8 items-center justify-center rounded-full border border-${theme_color} hover:border-${theme_color} hover:border-opacity-30 transform transition-transform duration-300 hover:scale-125`}>
                            <svg
                              width="8"
                              height="14"
                              viewBox="0 0 8 14"
                            ...
                            >
                              <path
                                ...
                                fill="currentColor" className={`text-${theme_color}`}
                              ></path>
                            </svg>
                          </div>
                        </a>
                      ...
                      <div className="w-auto p-1.5">
                        <a href=" https://www.instagram.com/chirag_baliyan31/" target="_blank">
                          <div className={`flex h-8 w-8 items-center justify-center rounded-full border border-${theme_color} hover:border-${theme_color} hover:border-opacity-30 transform transition-transform duration-300 hover:scale-125`}>
                            <svg
                              width="14"
                              height="11"
                      ...
                      <div className="w-auto p-1.5">
                        <a href=" https://www.instagram.com/_nandini.patel81/" target="_blank">
                          <div className={`flex h-8 w-8 items-center justify-center rounded-full border border-${theme_color} hover:border-${theme_color} hover:border-opacity-30 transform transition-transform duration-300 hover:scale-125`}>
                            <svg
                              width="16"
                              height="15"
